...
var input00 = document.getElementById('input-0').value;
var auction0 = Number.parseInt(input00);

var input01 = document.getElementById('input-1').value;
var auction1 = Number.parseInt(input01);

if (rangeSlider) {
	noUiSlider.create(rangeSlider, {
		start: [auction0, auction1],
		connect: true,
