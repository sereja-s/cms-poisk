...
<body>
      ...
      <div class="container">
        <div class="header__top-wrapper">
          ...
          <div class="header__location">
            <a class="header__location-link popup-open-modal" href="#change-city-popup">Киев</a>
          </div>
          ...
          <div class="header__topNav">
            <ul class="header__topNav-menu">
              <li class="header__topNav-item"><a class="header__topNav-link popup-open-modal"
                  href="#popup-lk">Отзывы</a></li>
              <li class="header__topNav-item"><a class="header__topNav-link popup-open-modal" href="#popup-sms">О
                  нас</a></li>
              <li class="header__topNav-item"><a class="header__topNav-link popup-open-modal"
                  href="#popup-buy-one-click">Доставка</a></li>
              <li class="header__topNav-item"><a class="header__topNav-link" href="#">Оплата</a></li>
              <li class="header__topNav-item"><a class="header__topNav-link" href="#">Подключение техники</a></li>
            ...
            <div class="header__more-menu">
              ...
              <ul class="header__topNav-menu2">
                <li class="header__topNav-item2"><a class="header__topNav-link2 popup-open-modal"
                    href="#popup-lk">Отзывы</a></li>
                ...
                <li class="header__topNav-item2"><a class="header__topNav-link2" href="#">Подключение техники</a></li>
                ...
                <li class="header__topNav-item2"><a class="header__topNav-link2" href="#">Оставить обращение</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="header__button-icons">
            ...
            <div class="header__social2">
              <a class="header__social-item2" href="#" target="_blank"><img src="img/icons/viber.svg" alt="Viber"></a>
              <a class="header__social-item2" href="#" target="_blank"><img src="img/icons/telegram.svg"
                  alt="Telegram"></a>
            </div>
            <!-- contacts 2 -->
        ...
        <div class="header__center-wrapper">
          ...
          <div class="header__center-left">
            ...
            <div class="header__logo">
              <a class="header__logo-img" href="/">
                <img src="img/logo-header-center.png" alt="ELECITY">
              </a>
            </div>
            <!-- all category -->
            <div class="header__bottom-all2">
              <a class="header__all-category-link2" href="#"><span class="header__all-category-icon2"></span>Все
                категории</a>
            </div>
            <!-- menu -->
            <div class="header__centerNav">
              <ul class="header__centerNav-menu">
                ...
                <li class="header__centerNav-item"><a class="header__centerNav-link" href="#">Инструменты</a></li>
              </ul>
            </div>
            <!-- search input -->
          ...
          <div class="header__center-right">
            ...
            <div class="header__social">
              <a class="header__social-item" href="#" target="_blank"><img src="img/icons/viber.svg" alt="Viber"></a>
              <a class="header__social-item" href="#" target="_blank"><img src="img/icons/telegram.svg"
                  alt="Telegram"></a>
            </div>
            <!-- contacts -->
              ...
              <div class="header-cart">
                <div class="header__cart__item">
                  <div class="header__cart__image">
                    <a href="#">
                      <img class="header__cart__img" src="img/hol-1.png" alt="">
                    </a>
                  </div>
      ...
      <div class="container">
        <div class="header__bottom-wrapper">
          ...
          <div class="header__bottomNav">
            <ul class="header__bottomNav-menu">
              <li class="header__bottomNav-item"><a class="header__bottomNav-link" href="#">Бытовая техника</a></li>
              <li class="header__bottomNav-item"><a class="header__bottomNav-link" href="#">Видео и аудио</a></li>
              <li class="header__bottomNav-item"><a class="header__bottomNav-link" href="#">Климат</a></li>
              <li class="header__bottomNav-item"><a class="header__bottomNav-link" href="#">Компьютерная техника</a>
              </li>
              <li class="header__bottomNav-item"><a class="header__bottomNav-link" href="#">Дом и дача</a></li>
              <li class="header__bottomNav-item"><a class="header__bottomNav-link" href="#">Спорт и отдых</a></li>
              <li class="header__bottomNav-item"><a class="header__bottomNav-link" href="#">Инструмент</a></li>
              <li class="header__bottomNav-item"><a class="header__bottomNav-link" href="#">Авто </a></li>
            </ul>
          </div>
          <!-- sale -->
          <div class="header__bottomSale">
            <ul class="header__bottomSale-menu">
              <li class="header__bottomSale-item"><a class="header__bottomSale-link" href="#">% Распродажа</a></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div id="navi-category" class="navi-category__bg">
          ...
          <div class="navi-category__content">
            ...
            <ul class="navi-category__list">
              ...
              <li class="navi-category__list-item">
                <a data-attribute="2" href="#" class="navi-category__list-link">Крупная бытовая техника</a>
              </li>
              <li class="navi-category__list-item">
                <a data-attribute="3" href="#" class="navi-category__list-link">Техника для кухни</a>
              </li>
              <li class="navi-category__list-item">
                <a data-attribute="4" href="#" class="navi-category__list-link">Встраиваемая бытовая техника</a>
              </li>
              <li class="navi-category__list-item">
              ...
              <li class="navi-category__list-item">
                <a data-attribute="8" href="#" class="navi-category__list-link">Крупная бытовая техника</a>
              </li>
              <li class="navi-category__list-item">
                <a data-attribute="9" href="#" class="navi-category__list-link">Техника для кухни</a>
              </li>
              <li class="navi-category__list-item">
                <a data-attribute="10" href="#" class="navi-category__list-link">Встраиваемая бытовая техника</a>
              </li>
              <li class="navi-category__list-item">
              ...
              <li class="navi-category__list-item">
                <a data-attribute="14" href="#" class="navi-category__list-link">Крупная бытовая техника</a>
              </li>
              <li class="navi-category__list-item">
                <a data-attribute="15" href="#" class="navi-category__list-link">Техника для кухни</a>
              </li>
              <li class="navi-category__list-item">
                <a data-attribute="16" href="#" class="navi-category__list-link">Встраиваемая бытовая техника</a>
              </li>
              <li class="navi-category__list-item">
                  ...
                  <ul class="navi-category__category-menu">
                    <li class="navi-category__category-item">
                      ...
                      <ul class="navi-category-subcategory-menu">
                        ...
                        <li class="navi-category-subcategory-item">
                          <a class="navi-category-subcategory__link" href="#">Инвентарь для уборки</a> (87)
                        </li>
                        <li class="navi-category-subcategory-item">
                          <a class="navi-category-subcategory__link" href="#">Мусорные ведра и баки</a> (56)
                        </li>
                        <li class="navi-category-subcategory-item">
                          <a class="navi-category-subcategory__link" href="#">Стремянки</a> (2)
                        </li>
                ...
                <div class="navi-category__submenu-banner">
                  <a class="navi-category__sb-link" style="background-color:#F3F8FF;" href="#">
                    ...
                    <div class="navi-category__sb-image">
                      <img class="navi-category__sb-img" src="img/iphone.jpg" alt="iphone">
                    </div>
  ...
  <section class="index-slider">
    <div class="container">
      <div class="index-slider__wrapper">
        ...
        <div class="index-slider__wrapper-bg">
          <!-- sldier item -->
          <div class="index-slider__item">
            <div class="index-slider__item-wrapper">
              ...
              <div class="index-slider__item-picture">
                <img class="index-slider__item-img" src="img/index-slider.png" alt="Большой выбор стиральных машин">
              </div>
            </div>
          </div>
          <!-- sldier item off-->
      ...
      <div class="index-catalog__banner">
        <a class="index-catalog__banner-link" href="#">
          ...
          <div class="index-catalog__banner-img">
            <img src="img/baner-img.png" alt="AirPods Pro">
          </div>
        ...
        <div class="catalog-list__item">
          ...
          <ul class="catalog-list__category-nav">
            <li class="catalog-list__category-item"><a class="catalog-list__category-link" href="#">Холодильники
                (135)</a></li>
            <li class="catalog-list__category-item"><a class="catalog-list__category-link" href="#">Морозильные камеры
                (74)</a></li>
            <li class="catalog-list__category-item"><a class="catalog-list__category-link" href="#">Стиральные машины
                (213)</a></li>
      ...
      <div class="index-news__wrapper">
        ...
        <div class="index-news__list">
          <div class="index-news__item index-news__first-item">
            <a class="index-news__link" href="#">
              <div class="index-news__item-bg">
                ...
                <span class="index-news__mini-title">Обзор на Робот-пылесос Xiaomi Mi Robot Vacuum Cleaner</span>
                <img class="index-news__img" src="img/news-1.png" alt="Эффективная уборка без лишних проводов">
              </div>
            </a>
          </div>
          ...
          <div class="index-news__item">
            <a class="index-news__link" href="#">
              <img class="index-news__img" src="img/news-2.jpg" alt="Как выбрать снегоуборщик">
              <div class="index-news__item-bg">
          ...
          <div class="index-news__item">
            <a class="index-news__link" href="#">
              <img class="index-news__img" src="img/news-3.jpg" alt="Как выбрать стиральную машину">
              <div class="index-news__item-bg">
          ...
          <div class="index-news__item">
            <a class="index-news__link" href="#">
              <img class="index-news__img" src="img/news-4.jpg"
                alt="Самая дорогая видеоигра в мире Cyberpunk 2077 для TV Samsung 4K QLED">
              <div class="index-news__item-bg">
                <span class="index-news__title">Самая дорогая видеоигра в мире Cyberpunk 2077 для TV Samsung 4K
                  QLED</span>
              </div>
            </a>
          </div>
          ...
          <div class="index-news__item">
            <a class="index-news__link" href="#">
              <img class="index-news__img" src="img/news-5.jpg"
                alt="PlayStation 5: захватывающее обновление, на которое мы надеялись">
              <div class="index-news__item-bg">
                <span class="index-news__title">PlayStation 5: захватывающее обновление, на которое мы надеялись</span>
              </div>
            </a>
          </div>
          ...
          <div class="index-news__item">
            <a class="index-news__link" href="#">
              <img class="index-news__img" src="img/news-6.jpg"
                alt="Путеводитель по покупкам: стоит ли покупать ноутбук или настольный компьютер?">
              <div class="index-news__item-bg">
                <span class="index-news__title">Путеводитель по покупкам: стоит липокупать ноутбук или настольный
                  компьютер?</span>
              </div>
            </a>
          </div>
    ...
    <div class="container">
      <div class="index-stat__wrapper">
        ...
        <p>Порой возникает ситуация, когда в&nbsp;какой-то момент в&nbsp;вашем доме требуется заменить один или
          ...
          с&nbsp;нуля. Это включает в&nbsp;себя покупку крупной бытовой техники, такую ​​как холодильники стиральные
          и&nbsp;посудомоечные машины, а&nbsp;также более мелкую бытовую технику, которая значительно сокращает время
          на&nbsp;кухне или при уборке. Наш интернет-магазин бытовой техники поможет с&nbsp;выбором, гарантируя низкие
          цены и&nbsp;выгодные покупки на&nbsp;все линейки товаров.</p>
        <p><b>Холодильники</b></p>
        <p>Подобно автомобилю или другой крупногабаритной технике, стоит знать, на&nbsp;что обращать внимание при выборе
          холодильника для кухни. Например, при выборе холодильника важно знать, что искать, например, сколько дверей
          вы&nbsp;хотите, где разместить морозильную камеру, хотите&nbsp;ли вы&nbsp;внешний льдогенератор, диспенсер для
          воды, предназначенные для сохранения свежести ваших продуктов на&nbsp;более длительные периоды времени. Размер
          является важным фактором, от&nbsp;небольшие по&nbsp;объему до&nbsp;больших, которые идеально подходят для
          офисов, комнат общежития и&nbsp;малогабаритных квартир. Также важны другие параметры, такие как цвет, ширина,
          бренд и&nbsp;рейтинг.</p>
        <p><b>Тостеры</b></p>
        <p>Такую&nbsp;же внимательность при выборе крупногабаритной техники следует проявлять и&nbsp;в&nbsp;отношении
          небольших приборов. Учитывайте количество человек в&nbsp;семье, частоту пользования&nbsp;&mdash; от&nbsp;этого
          зависит, какой именно тостер следует рассмотреть: будет&nbsp;ли он&nbsp;на&nbsp;два или четыре ломтика хлеба,
          имеет он&nbsp;ручное или цифровое управление, и&nbsp;должен&nbsp;ли тостер быть определенного цвета, будет
          нержавеющая сталь сочетается с&nbsp;вашим декором? Вы&nbsp;даже можете выбрать тостер, который одновременно
          выполняет несколько функций, что дает ему преимущество на&nbsp;вашей кухне.</p>
        <p>
          <b>Микроволновые печи</b>
        </p>
        <p>Говоря об&nbsp;универсальных приборах, на&nbsp;кухне нет ничего более универсального, чем микроволновые печи.
          ...
          и&nbsp;размягчение сливочного масла. Микроволновки обычно доступны в&nbsp;трех видах: на&nbsp;столешнице,
          подвесные и&nbsp;встраиваемые. Опять&nbsp;же, есть факторы, которые следует учитывать при выборе микроволновой
          печи, и&nbsp;у&nbsp;нас есть разные модели, из&nbsp;которых вы&nbsp;можете выбрать. В&nbsp;наличии имеются
          небольшие устройства с&nbsp;объемом для приготовления пищи от&nbsp;13&nbsp;литров или меньше
          до&nbsp;44&nbsp;литров или более. Еще одно соображение&nbsp;&mdash; мощность, и&nbsp;у&nbsp;нас есть модели,
          которые варьируются от&nbsp;менее 700&nbsp;Вт до&nbsp;более 1000&nbsp;Вт; чем выше мощность&nbsp;&mdash; тем
      ...
      <div class="footer-icons__wrapper">
        ...
        <div class="footer-icons__item">
          <div class="footer-icons__img">
            <img src="img/icons/footer-icon-1.svg" alt="11 лет опыт">
          </div>
        ...
        <div class="footer-icons__item">
          <div class="footer-icons__img">
            <img src="img/icons/footer-icon-2.svg" alt="Возврат и обмен">
          </div>
        ...
        <div class="footer-icons__item">
          <div class="footer-icons__img">
            <img src="img/icons/footer-icon-3.svg" alt="Установка">
          </div>
        ...
        <div class="footer-icons__item">
          <div class="footer-icons__img">
            <img src="img/icons/footer-icon-4.svg" alt="Высокое качество">
          </div>
        ...
        <div class="footer-icons__item">
          <div class="footer-icons__img">
            <img src="img/icons/footer-icon-5.svg" alt="Гарантия на все">
          </div>
      ...
      <div class="footer__wrapper">
        ...
        <div class="footer__info">
          ...
          <a href="#" class="footer__logo-link">
            <img class="footer__logo-img" src="img/logo-header-center.png" alt="ELECITY">
          </a>
          ...
          <div class="footer__social">
            <a class="footer__social-link" href="#" target="_blank"><img src="img/icons/footer-tg.svg"
                alt="telegram"></a>
            <a class="footer__social-link" href="#" target="_blank"><img src="img/icons/footer-vk.svg"
                alt="vkontakte"></a>
            <a class="footer__social-link" href="#" target="_blank"><img src="img/icons/footer-vb.svg" alt="vaiber"></a>
            <a class="footer__social-link" href="#" target="_blank"><img src="img/icons/footer-odn.svg"
                alt="odnoklasniki"></a>
          </div>
    ...
    <div class="footer__copyright">
      <div class="container">
        <p class="footer__copyright-text">Обращаем Ваше внимание на&nbsp;то, что данный интернет-сайт носит
          ...
          <br>elecity.ua &copy;&nbsp;2011-2022</p>
      </div>
    </div>
  ...
  <div id="popup-buy-one-click" class="white-popup mfp-hide">
    <div class="popup-form">
      ...
      <div class="popup-form__text">
        Укажите Ваше имя и свой номер телефона для оформления заказа. Оператор перезвонит Вам, чтобы подтвердить заказ и
      ...
      <div class="search-popup__product-item">
        <div class="search-popup__product-left">
          <div class="search-popup__product-image">
            <a href="#">
              <img class="search-popup__product-img" src="img/hol-1.png" alt="">
            </a>
          </div>
